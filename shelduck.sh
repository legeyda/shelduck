...
shelduck_run() {
	...
	shelduck_run_args="$shelduck_parse_cli_args" # save latest run args, since recursive imports use it
	shelduck_exec "$shelduck_parse_cli_aliases" "$shelduck_parse_cli_command" "$shelduck_run_url" "$shelduck_parse_cli_args"
	unset shelduck_parse_cli_aliases shelduck_parse_cli_command shelduck_parse_cli_url shelduck_parse_cli_args
...
shelduck_import() {
	...
	# delegate to shelduck_exec
	shelduck_exec "$shelduck_parse_cli_aliases" '' "$shelduck_import_url" "${shelduck_run_args:-}"
	unset shelduck_parse_cli_aliases shelduck_parse_cli_command shelduck_parse_cli_url shelduck_parse_cli_args
...
shelduck_print() {
	...
	if [ -n "${SHELDUCK_URL_RULES:-}" ]; then
		...
		while true; do
			if ! bobshell_split_first "$shelduck_print_rules" ',' shelduck_print_rule shelduck_print_rules; then
				shelduck_print_rule="$shelduck_print_rules"
				shelduck_print_rules=
			fi
		...
		unset shelduck_print_rules shelduck_print_rule
	...
	set -- "$shelduck_print_script" "$shelduck_print_url" "$shelduck_parse_cli_aliases" "$shelduck_base_url" "$shelduck_print_initial_base_url"

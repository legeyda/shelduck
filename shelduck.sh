...
shelduck_import() {
	...
	if bobshell_contains "$shelduck_import_history" "$shelduck_import_url"; then
		...
		shelduck_import_addition=$(shelduck_print_addition "$shelduck_exec_origin" "$shelduck_import_url" "$shelduck_parse_cli_aliases")
	...
	# delegate to shelduck_exec
	shelduck_exec "$shelduck_parse_cli_aliases" '' "$shelduck_import_url" ''
	unset shelduck_parse_cli_aliases shelduck_parse_cli_command shelduck_parse_cli_url shelduck_parse_cli_args
...
shelduck_print() {
	...
	# apply url rules
	# todo import and run
	shelduck_print_url=$(shelduck_apply_rules "$shelduck_print_url" "${SHELDUCK_URL_RULES:-}")

...
shelduck_run() {
	...
	if [ -n "$shelduck_parse_cli_url" ]; then
		...
		shelduck_run_origin=$(shelduck_print_origin "$shelduck_run_url")
		shelduck_run_additions=$(shelduck_print_addition "$shelduck_run_origin" "$shelduck_run_url" "$shelduck_parse_cli_aliases")
